...
| Scorecard analysis | the supply chain score, published weekly and on the default branch | workflow .github/workflows/scorecard.yml | no | #85 | the run exists and its findings are not triaged, which is what #85 owes |
